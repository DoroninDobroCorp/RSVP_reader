...
(function initialisePaceFlowI18n(global) {
    const messages = {
        ...
        ru: {
            ...
            textPlaceholder: 'Вставьте текст или импортируйте EPUB, FB2, DOCX, TXT, HTML, Markdown или RTF…', bookNamePlaceholder: 'Название книги (необязательно)',
            ...
            addBookmark: 'Добавить закладку', stopFocusMode: 'Закрыть фокус-режим', pause: 'Пауза', continue: 'Продолжить', sessionProgress: 'Сеанс 0% · книга 0% · осталось 0 мин', targetWpmShort: 'Цель 350 слов/мин',
            ...
            punctuationPauses: 'Паузы на пунктуации', commaPause: 'Множитель запятой', periodPause: 'Множитель конца предложения', semicolonPause: 'Множитель точки с запятой и двоеточия', controls: 'Управление', hardwareControls: 'Внешнее медиауправление', hardwareControlsHint: 'Использует события Play/Pause на совместимых веб-платформах. Пробел в читалке работает всегда. На iOS кнопки громкости не переназначаются.', yourData: 'Ваши данные', yourDataHint: 'Книги и прогресс чтения остаются на этом устройстве. Можно экспортировать резервную копию или навсегда стереть локальные данные приложения.', exportBackup: 'Экспортировать копию', deleteAllData: 'Удалить все локальные данные', confirmDeleteAllData: 'Навсегда удалить из PaceFlow Reader все локальные книги, закладки, позиции чтения и настройки?', allDataDeleted: 'Все локальные данные PaceFlow Reader удалены.', deleteAllFailed: 'Не удалось безопасно удалить локальные данные. Ничего не очищено; повторите попытку или переустановите приложение.', deleteBookFailed: 'Не удалось безопасно удалить книгу. Ничего не очищено; повторите попытку или переустановите приложение.', resetSettings: 'Вернуть настройки по умолчанию',
