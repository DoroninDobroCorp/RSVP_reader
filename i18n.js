...
(function initialisePaceFlowI18n(global) {
    const messages = {
        en: {
            ...
            appearance: 'Appearance', readingFont: 'Reading font', fontSans: 'Sans', fontSerif: 'Serif', fontMono: 'Mono', fontRounded: 'Rounded', backToText: 'Text',
            language: 'Language',
        ...
        ru: {
            ...
            appearance: 'Оформление', readingFont: 'Шрифт для чтения', fontSans: 'Санс', fontSerif: 'Сериф', fontMono: 'Моно', fontRounded: 'Скругленный', backToText: 'Текст', language: 'Язык', languageHint: 'Если язык системы русский или испанский, приложение выберет его автоматически; здесь язык всегда можно сменить.', english: 'English', russian: 'Русский', spanish: 'Español', theme: 'Тема', night: 'Ночная', day: 'Дневная',
        ...
        es: {
            ...
            appearance: 'Apariencia', readingFont: 'Fuente de lectura', fontSans: 'Sans', fontSerif: 'Serif', fontMono: 'Mono', fontRounded: 'Redondeada', backToText: 'Texto',
            language: 'Idioma',
