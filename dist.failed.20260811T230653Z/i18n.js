...
(function initialisePaceFlowI18n(global) {
    const messages = {
        en: {
            ...
            heroPromise: 'No account · no upload · no tracking',
            heroWordBefore: 'keep',
            heroWordFocus: 'your',
            heroWordAfter: 'rhythm',
            picoSignature: 'PICO · FOCUS PILOT',
            flowMapLabel: 'How PaceFlow works',
            ...
            chromeExtensionTitle: 'Send from Chrome in one click',
            chromeExtensionHint: 'Select text, copy a passage, or right-click an article and open it directly in PaceFlow.',
            chromeExtensionDownload: 'Download Chrome extension',
            chromeExtensionInstall: 'Install in Chrome',
            ...
            chromeExtensionPrivacy: 'It reads a selection or clipboard only when you explicitly press a PaceFlow action. No browsing-history permission or analytics.',
            ...
            extensionOpen: 'Open in PaceFlow',
            ...
            articleImportHint: 'PaceFlow removes menus and distractions, then saves the readable text to your library.',
        ...
        ru: {
            appName: 'PaceFlow Reader', appTagline: 'Читайте в ритме с Пико', heroKicker: 'Пико · ваш штурман по тексту', heroTitle: 'Длинные тексты.', heroTitleAccent: 'Без пробуксовки.', heroHint: 'Пико превращает книги, статьи и вставленный текст в спокойный ритм, который ведёт взгляд и не даёт потерять место.', heroPromise: 'Без аккаунта · без загрузки · без слежки', heroWordBefore: 'держи', heroWordFocus: 'свой', heroWordAfter: 'ритм', picoSignature: 'ПИКО · ПИЛОТ ФОКУСА', flowMapLabel: 'Как работает PaceFlow', flowBringTitle: 'Добавьте текст', flowBringHint: 'Вставьте, импортируйте или отправьте из Chrome.', flowPaceTitle: 'Выберите темп', flowPaceHint: 'Пико подстраивает ритм под слова и пунктуацию.', flowReadTitle: 'Оставайтесь в потоке', flowReadHint: 'Читайте, ставьте на паузу и возвращайтесь точно на место.', dockKicker: 'Читательский док Пико', dockTitle: 'Что будем читать?', dockHint: 'Положите текст в основную полосу или используйте быстрый маршрут для ссылки и Chrome.', pasteSourceTitle: 'Вставить или импортировать', pasteSourceHint: 'Текст остаётся читаемым, редактируемым и локальным.', fastLanes: 'Быстрые маршруты чтения', skipToContent: 'Перейти к содержимому', homeAria: 'На главную PaceFlow Reader', bookTitleLabel: 'Название книги', readingControls: 'Управление чтением', checkingCache: 'Подготовка офлайн-режима…',
