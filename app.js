...
class RSVPReader {
    constructor() {
        ...
        // Touch interaction state - simplified
        this.touchState = {
            lastTapTime: 0,
            isInCooldown: false,
            cooldownTimer: null
    ...
    attachEventListeners() {
        ...
        // Double click/tap to start/stop RSVP - simplified handlers
    ...
    isButtonOrControl(element) {
        ...
        if (tagName === 'button' || tagName === 'input') return true;
