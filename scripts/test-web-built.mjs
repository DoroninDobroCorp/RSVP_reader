...
try {
  ...
  for (const subpath of subpathsToTest) {
    ...
    for (const route of ['/', '/index.html', '/reset.html', '/ru/', '/ru/index.html', '/es/', '/es/index.html', '/privacy.html', '/support.html', '/acknowledgements.html']) {
    ...
    const staticAssets = [
      '/style.css?v=53',
      '/app-base-url.js?v=53',
      '/i18n.js?v=53',
      '/app.js?v=53',
      '/epub-parser.js?v=53',
      '/vendor/jszip.min.js?v=53',
    ...
    const precacheList = eval(`const ASSET_VERSION = 'v=53'; [${match[1]}]`);
    ...
    const appJsUrl = `${baseUrl}/app.js?v=53`;
  ...
  await assert.rejects(stat(join(root, 'dist-native', 'reset.html')), 'Native build must exclude the web-only cache reset page');
