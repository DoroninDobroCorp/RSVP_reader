...
// 1. Verify package.json dependency
...
if (!appGradle.includes('compileSdk = rootProject.ext.compileSdkVersion')
    && !appGradle.includes('compileSdkVersion 36')) {
    // verify variable or direct declaration
}
...
console.log('Android package verification PASSED: SDK 36, AGP 8.5, Java 21, zero dangerous permissions, clean native asset stripping.');
